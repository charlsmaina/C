...
pseudocode:
    ...
    -------this is a minimalist version that uses no flags to check whether a character in s1 is in s2------------
...
int main()
{
    ...
    {
        printf("s1 :%s", s1); // why is it i dont need newline
        printf("s2 : %s", s2);
        squeeze(s1, s2);
    }
}
